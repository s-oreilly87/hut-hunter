...
export function AuthHero({ className }: { className?: string }) {
  return (
    <section className={cn('app-panel flex flex-col justify-between overflow-hidden p-6 sm:p-8', className)}>
      <div>
        ...
        <p className="mt-8 text-sm font-medium tracking-[0.2em] text-primary/80 uppercase">
          Booking Assistant
        </p>
        ...
        <p className="place-self-end text-sm text-muted-foreground">(*cough* Mueller Hut . . . )</p>
